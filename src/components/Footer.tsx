        ...
        <div className="border-t border-gray-800 dark:border-gray-700 mt-16 pt-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-8">
              ...
              <a href="mailto:learncasmarketing@gmail.com" className="flex items-center space-x-2 text-gray-400 hover:text-primary-400 transition-colors font-medium text-lg">
                <Mail className="w-5 h-5" />
                <span>learncasmarketing@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
